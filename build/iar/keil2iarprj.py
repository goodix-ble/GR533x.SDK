...
######################################################################################################################
#  Usage :
#       used to transfer GR533x's Keilv5 App Project to iar project which is compiled by iar Compiler
#  Command :
...
def main():
    ...
    file_icf_config = "flash_icf_config.c"
    file_GR5xxx_make_icf = "GR5xxx_make_icf.bat"
    file_make_app_dependent_icf = "make_app_dependent_icf.py"
