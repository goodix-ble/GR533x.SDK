...
static void hmac_clock_enable(void)
{
    ...
    g_encryption_clock |= ENCRY_CLOCK_HMAC;
}
                                ...
                                const unsigned char data[64] )
{
    ...
    while(READ_BITS(HMAC->STATUS, LL_HMAC_FLAG_DATAREADY_SHA) == 0U);
